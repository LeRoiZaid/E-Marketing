...
import 'package:e_markting/dashboard/modules/users/model/repo/parent_data.dart';
...
""");
  ...
  @override
  Future<void> insert({required String name, required String email, required int age, required String address}) async {
    await _database.insert('user', {'name': name, 'email': email, 'age': age, 'address': address});
}
